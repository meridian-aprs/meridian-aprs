...
/// Fully controllable [KissTncTransport] for use in serial connection tests.
class FakeSerialKissTransport extends KissTncTransport {
  ...
  Future<void> connect() async {
    ...
    if (connectThrows) {
      ...
      throw Exception('FakeSerialKissTransport: connect failed');
    }
  ...
  Future<void> sendFrame(Uint8List ax25Frame) async {
    if (!isConnected) {
      throw StateError('FakeSerialKissTransport: not connected');
    }
